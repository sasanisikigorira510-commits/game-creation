...
public static class UnityMcpSceneBuilder
{
    ...
    public static void RebuildMinimalHomeScene()
    {
        ...
        CreateSectionHeader(equipmentPanel.transform, "装備構成", "解放済み装備を入れ替えて戦闘傾向を調整します。");
        ...
        TMP_Text towerMarker = CreateLabel("TowerPreviewMarker", towerPreview.transform, new Vector2(0.5f, 0.18f), Vector2.zero, new Vector2(90f, 28f), "次へ");
        StyleText(towerMarker, 16f, FontStyles.Bold, new Color(0.07f, 0.09f, 0.12f, 0.95f), TextAlignmentOptions.Center);
        TMP_Text towerFloorBadge = CreateLabel("TowerFloorBadge", launchCard.transform, new Vector2(0f, 1f), new Vector2(128f, -168f), new Vector2(130f, 30f), "目標階層");
        StyleText(towerFloorBadge, 15f, FontStyles.Bold, new Color(1f, 0.84f, 0.58f, 0.92f), TextAlignmentOptions.Center);
        TMP_Text launchOverline = CreateLabel("LaunchOverline", launchCard.transform, new Vector2(0.5f, 1f), new Vector2(0f, -26f), new Vector2(620f, 28f), "次の探索");
        StyleText(launchOverline, 18f, FontStyles.Bold, new Color(1f, 0.83f, 0.54f, 1f), TextAlignmentOptions.Center);
        TMP_Text launchTitle = CreateLabel("LaunchTitle", launchCard.transform, new Vector2(0.5f, 1f), new Vector2(0f, -62f), new Vector2(620f, 42f), "次の階層へ挑戦");
        StyleText(launchTitle, 30f, FontStyles.Bold, new Color(0.97f, 0.98f, 1f, 1f), TextAlignmentOptions.Center);
        TMP_Text launchBody = CreateLabel("LaunchBody", launchCard.transform, new Vector2(0.5f, 0.5f), new Vector2(0f, 0f), new Vector2(620f, 52f), "装備を整え、門をくぐって塔の奥へ進みましょう。");
        StyleText(launchBody, 18f, FontStyles.Normal, new Color(0.78f, 0.84f, 0.92f, 0.95f), TextAlignmentOptions.Center);
        TMP_Text launchFlavor = CreateLabel("LaunchFlavor", launchCard.transform, new Vector2(0.66f, 0f), new Vector2(0f, 24f), new Vector2(420f, 28f), "深く進むほど、塔の鼓動は強くなる。");
        ...
        TMP_Text floorCardLabel = CreateLabel("FloorPreviewLabel", floorCard.transform, new Vector2(0f, 0.5f), new Vector2(108f, 0f), new Vector2(160f, 34f), "探索ルート");
        StyleText(floorCardLabel, 24f, FontStyles.Bold, new Color(0.93f, 0.96f, 1f, 0.98f), TextAlignmentOptions.Center);
        TMP_Text floorCardBody = CreateLabel("FloorPreviewBody", floorCard.transform, new Vector2(0.55f, 0.5f), new Vector2(32f, 0f), new Vector2(500f, 60f), "拠点で編成と装備を整え、上の探索門から次の階層へ向かいます。");
        ...
        Button homeNavButton = CreateNavButton(navBar.transform, "ホーム", new Vector2(-270f, 0f), panelSwitcher, nameof(PanelSwitcher.ShowHome), new Vector2(168f, 48f));
        Button enhanceNavButton = CreateNavButton(navBar.transform, "育成", new Vector2(-90f, 0f), panelSwitcher, nameof(PanelSwitcher.ShowEnhance), new Vector2(168f, 48f));
        Button equipmentNavButton = CreateNavButton(navBar.transform, "装備", new Vector2(90f, 0f), panelSwitcher, nameof(PanelSwitcher.ShowEquipment), new Vector2(168f, 48f));
        Button missionNavButton = CreateNavButton(navBar.transform, "ミッション", new Vector2(270f, 0f), panelSwitcher, nameof(PanelSwitcher.ShowMission), new Vector2(168f, 48f));
        ...
        SetObjectField(homePanelController, "ctaText", CreateCtaLabel("HomeCtaText", homePanel.transform, "次の行動: バトルで次の階層に挑戦しましょう。"));
        TMP_Text homeRewardSummaryText = CreateLabel("HomeRewardSummaryText", homePanel.transform, new Vector2(0.5f, 1f), new Vector2(0f, -432f), new Vector2(660f, 34f), "受取可能なゴールド: 現在なし");
        ...
        TMP_Text prepAdviceText = CreateLabel("PrepAdviceText", homePanel.transform, new Vector2(0.5f, 1f), new Vector2(0f, -466f), new Vector2(670f, 34f), "準備助言: 現在の戦力なら有利です。整ったら進みましょう。");
        ...
        TMP_Text battlePlanText = CreateLabel("BattlePlanText", homePanel.transform, new Vector2(0.5f, 1f), new Vector2(0f, -500f), new Vector2(670f, 34f), "バトル計画: 準備完了。第2階層へ挑戦できます。");
        ...
        TMP_Text homeActionRailText = CreateLabel("HomeActionRailText", homeActionRail.transform, new Vector2(0.5f, 0.5f), Vector2.zero, new Vector2(640f, 34f), "報酬を受け取り、塔の門から探索へ出発しましょう。");
        ...
        SetObjectField(enhancePanelController, "ctaText", CreateCtaLabel("EnhanceCtaText", enhancePanel.transform, "強化優先: 次の強化に向けてゴールドを温存しましょう。"));
        ...
        SetObjectField(missionPanelController, "ctaText", CreateCtaLabel("MissionCtaText", missionPanel.transform, "ミッション方針: 階層を進めて報酬を増やしましょう。"));
        TMP_Text missionRewardSummaryText = CreateLabel("MissionRewardSummaryText", missionPanel.transform, new Vector2(0.5f, 1f), new Vector2(0f, -620f), new Vector2(660f, 34f), "受取可能報酬: 現在なし");
        ...
        Button battleNavButton = CreateNavButton(navBar.transform, "バトル", new Vector2(0f, -70f), homeSceneController, nameof(HomeSceneController.StartBattle), new Vector2(240f, 54f));
        StyleButton(battleNavButton, new Color(0.75f, 0.39f, 0.16f, 1f));
        CreatePrimaryButtonAura(battleNavButton.transform, "BattleNavAura", new Vector2(268f, 72f), new Color(0.97f, 0.84f, 0.56f, 0.10f), "出撃");
        Button challengeFloorButton = CreateNavButton(launchCard.transform, "階層へ挑戦", new Vector2(0f, 62f), homeSceneController, nameof(HomeSceneController.StartBattle), new Vector2(320f, 58f));
        StyleButton(challengeFloorButton, new Color(0.77f, 0.39f, 0.16f, 1f));
        CreatePrimaryButtonAura(challengeFloorButton.transform, "ChallengeFloorAura", new Vector2(352f, 78f), new Color(0.98f, 0.84f, 0.56f, 0.12f), "探索");
        ...
        CreateGearRowLabel(equipmentPanel.transform, "WeaponRowLabel", new Vector2(0f, -586f), "武器ライン");
        CreateGearRowLabel(equipmentPanel.transform, "ArmorRowLabel", new Vector2(0f, -676f), "防具ライン");
        CreateGearRowLabel(equipmentPanel.transform, "AccessoryRowLabel", new Vector2(0f, -766f), "装飾ライン");
        TMP_Text bronzeBladeStatusText = CreateLabel("BronzeBladeStatusText", equipmentPanel.transform, new Vector2(0.5f, 0.5f), new Vector2(-170f, -665f), new Vector2(220f, 24f), "初期装備");
        TMP_Text ironSwordStatusText = CreateLabel("IronSwordStatusText", equipmentPanel.transform, new Vector2(0.5f, 0.5f), new Vector2(170f, -665f), new Vector2(220f, 24f), "第2階層で解放");
        TMP_Text guardClothStatusText = CreateLabel("GuardClothStatusText", equipmentPanel.transform, new Vector2(0.5f, 0.5f), new Vector2(-170f, -755f), new Vector2(220f, 24f), "初期装備");
        TMP_Text boneMailStatusText = CreateLabel("BoneMailStatusText", equipmentPanel.transform, new Vector2(0.5f, 0.5f), new Vector2(170f, -755f), new Vector2(220f, 24f), "第4階層で解放");
        TMP_Text ashenRingStatusText = CreateLabel("AshenRingStatusText", equipmentPanel.transform, new Vector2(0.5f, 0.5f), new Vector2(-170f, -845f), new Vector2(220f, 24f), "初期装備");
        TMP_Text quickCharmStatusText = CreateLabel("QuickCharmStatusText", equipmentPanel.transform, new Vector2(0.5f, 0.5f), new Vector2(170f, -845f), new Vector2(220f, 24f), "第6階層で解放");
        ...
        SetObjectField(equipmentPanelController, "ctaText", CreateCtaLabel("EquipmentCtaText", equipmentPanel.transform, "装備方針: 深い階層を突破して装備の選択肢を増やしましょう。"));
    ...
    public static void RebuildMinimalBattleScene()
    {
        ...
        TMP_Text versusSubtext = CreateLabel("VersusSubtext", hudRoot.transform, new Vector2(0.5f, 0.46f), Vector2.zero, new Vector2(260f, 24f), "自動戦闘レーン");
        ...
        TMP_Text skillBarTitle = CreateLabel("SkillBarTitle", skillBar.transform, new Vector2(0.5f, 1f), new Vector2(0f, -24f), new Vector2(520f, 30f), "アクティブスキル");
        StyleText(skillBarTitle, 24f, FontStyles.Bold, new Color(0.94f, 0.96f, 1f, 1f), TextAlignmentOptions.Center);
        TMP_Text skillBarHint = CreateLabel("SkillBarHint", skillBar.transform, new Vector2(0.5f, 1f), new Vector2(0f, -54f), new Vector2(620f, 26f), "クールタイム中は暗くなり、使用可能になると点灯します。");
        StyleText(skillBarHint, 16f, FontStyles.Normal, new Color(0.73f, 0.80f, 0.90f, 0.94f), TextAlignmentOptions.Center);
        CreateSkillTag(skillBar.transform, "SkillTagLeft", new Vector2(0.2f, 0f), new Vector2(0f, 152f), "速攻");
        CreateSkillTag(skillBar.transform, "SkillTagCenter", new Vector2(0.5f, 0f), new Vector2(0f, 152f), "吸収");
        CreateSkillTag(skillBar.transform, "SkillTagRight", new Vector2(0.8f, 0f), new Vector2(0f, 152f), "防御");

        TMP_Text floorText = CreateLabel("FloorText", floorBadge.transform, new Vector2(0.5f, 0.5f), Vector2.zero, new Vector2(180f, 34f), "第1階層");
        TMP_Text playerHpText = CreateLabel("PlayerHpText", playerFrame.transform, new Vector2(0.5f, 1f), new Vector2(0f, -112f), new Vector2(250f, 40f), "味方HP");
        TMP_Text enemyHpText = CreateLabel("EnemyHpText", enemyFrame.transform, new Vector2(0.5f, 1f), new Vector2(0f, -112f), new Vector2(250f, 40f), "敵HP");
        TMP_Text skill1Text = CreateLabel("Skill1Text", skillBar.transform, new Vector2(0.2f, 0f), new Vector2(0f, 118f), new Vector2(180f, 40f), "強撃");
        TMP_Text skill2Text = CreateLabel("Skill2Text", skillBar.transform, new Vector2(0.5f, 0f), new Vector2(0f, 118f), new Vector2(180f, 40f), "吸収");
        TMP_Text skill3Text = CreateLabel("Skill3Text", skillBar.transform, new Vector2(0.8f, 0f), new Vector2(0f, 118f), new Vector2(180f, 40f), "防御");

        Button skillButton1 = CreateButton(skillBar.transform, "SkillButton1", "強撃", new Vector2(0.2f, 0f), new Vector2(0f, 60f), new Vector2(180f, 52f));
        Button skillButton2 = CreateButton(skillBar.transform, "SkillButton2", "吸収", new Vector2(0.5f, 0f), new Vector2(0f, 60f), new Vector2(180f, 52f));
        Button skillButton3 = CreateButton(skillBar.transform, "SkillButton3", "防御", new Vector2(0.8f, 0f), new Vector2(0f, 60f), new Vector2(180f, 52f));

        GameObject winLabel = CreateSimplePanel("WinLabel", hudRoot.transform, new Vector2(0.35f, 0.5f), new Vector2(220f, 70f), "勝利");
        GameObject loseLabel = CreateSimplePanel("LoseLabel", hudRoot.transform, new Vector2(0.65f, 0.5f), new Vector2(220f, 70f), "敗北");
    ...
    private static PlayerStatusView CreatePlayerStatusView(Transform parent, string name, Vector2 anchor, Vector2 position)
    {
        ...
        CreateStatChip(root.transform, name + "FloorChip", new Vector2(-222f, 48f), "階層");
        CreateStatChip(root.transform, name + "ExpChip", new Vector2(-222f, 118f), "経験値");
        ...
        TMP_Text floorText = CreateLabel("FloorText", root.transform, new Vector2(0.5f, 0.78f), new Vector2(0f, 4f), new Vector2(560f, 34f), "第1階層");
        ...
        TMP_Text expText = CreateLabel("ExpText", root.transform, new Vector2(0.5f, 0.56f), new Vector2(0f, 6f), new Vector2(560f, 30f), "経験値 0 / 10");
        ...
        TMP_Text progressText = CreateLabel("ProgressText", root.transform, new Vector2(0.5f, 0.34f), new Vector2(0f, -4f), new Vector2(640f, 34f), "次の階層: 2");
        ...
        TMP_Text rewardForecastText = CreateLabel("RewardForecastText", root.transform, new Vector2(0.5f, 0.22f), new Vector2(0f, -6f), new Vector2(660f, 30f), "報酬: 10ゴールド / 経験値5");
        ...
        TMP_Text threatText = CreateLabel("ThreatText", root.transform, new Vector2(0.5f, 0.14f), new Vector2(0f, -2f), new Vector2(660f, 30f), "危険度: 低");
        ...
        TMP_Text confidenceText = CreateLabel("ConfidenceText", root.transform, new Vector2(0.5f, 0.06f), new Vector2(0f, 8f), new Vector2(660f, 30f), "挑戦可能");
        ...
        TMP_Text loadoutAlertText = CreateLabel("LoadoutAlertText", root.transform, new Vector2(0.5f, 0.07f), new Vector2(0f, 2f), new Vector2(670f, 30f), "装備確認: 現在解放済みの中では最適な構成です。");
        ...
        TMP_Text goldRouteText = CreateLabel("GoldRouteText", root.transform, new Vector2(0.5f, 0.04f), new Vector2(0f, 2f), new Vector2(670f, 30f), "ゴールド方針: 次の強化に必要な分は確保できています。");
        ...
        TMP_Text upgradeRouteText = CreateLabel("UpgradeRouteText", root.transform, new Vector2(0.5f, 0.01f), new Vector2(0f, 2f), new Vector2(670f, 30f), "強化方針: 攻撃強化10ゴールドが最短の伸びしろです。");
        ...
        TMP_Text rewardRouteText = CreateLabel("RewardRouteText", root.transform, new Vector2(0.5f, 0.00f), new Vector2(0f, 2f), new Vector2(670f, 30f), "報酬方針: 受取待ちはありません。次の階層で新しい報酬を狙いましょう。");
        ...
        TMP_Text pushWindowText = CreateLabel("PushWindowText", root.transform, new Vector2(0.5f, 0.00f), new Vector2(0f, 18f), new Vector2(670f, 30f), "挑戦好機: 今すぐ第2階層へ進めます。");
        ...
        TMP_Text roiReadText = CreateLabel("RoiReadText", root.transform, new Vector2(0.5f, 0.00f), new Vector2(0f, 34f), new Vector2(670f, 30f), "回収見込み: 1回のクリアで次の10ゴールド強化をまかなえます。");
        ...
        TMP_Text decisionLineText = CreateLabel("DecisionLineText", root.transform, new Vector2(0.5f, 0.00f), new Vector2(0f, 50f), new Vector2(670f, 30f), "判断: 未受取報酬がなければ、このまま進みましょう。");
        ...
        TMP_Text decisionBadgeText = CreateLabel("DecisionBadgeText", root.transform, new Vector2(0.5f, 0.00f), new Vector2(0f, 66f), new Vector2(520f, 34f), "判断: 挑戦");
        ...
        TMP_Text commandStackText = CreateLabel("CommandStackText", root.transform, new Vector2(0.5f, 0.00f), new Vector2(0f, 92f), new Vector2(680f, 42f), "手順: 1. 第2階層を開く  2. 現在の構成を維持  3. 第2階層へ挑戦");
        ...
        TMP_Text tempoVerdictText = CreateLabel("TempoVerdictText", root.transform, new Vector2(0.5f, 0.00f), new Vector2(0f, 362f), new Vector2(680f, 30f), "進行判断: 主導権あり。報酬を受け取ってからでも間に合います。");
        ...
        TMP_Text pressureCallText = CreateLabel("PressureCallText", root.transform, new Vector2(0.5f, 0.00f), new Vector2(0f, 386f), new Vector2(680f, 30f), "圧力判断: 有利です。報酬を確保してから次へ進みましょう。");
        ...
        TMP_Text rewardPaceText = CreateLabel("RewardPaceText", root.transform, new Vector2(0.5f, 0.00f), new Vector2(0f, 410f), new Vector2(680f, 30f), "報酬ペース: 安定。目安は毎分180ゴールドと経験値90です。");
        ...
        TMP_Text priorityText = CreateLabel("PriorityText", root.transform, new Vector2(0.5f, 0.00f), new Vector2(0f, 434f), new Vector2(660f, 30f), "優先行動: 次はバトル。第2階層に挑戦しましょう。");
    ...
    private static EquipmentStatusView CreateEquipmentStatusView(Transform parent, string name, Vector2 anchor, Vector2 position)
    {
        ...
        SetObjectField(view, "weaponText", CreateLabel("WeaponText", root.transform, new Vector2(0.5f, 1f), new Vector2(0f, -20f), new Vector2(560f, 30f), "武器: -"));
        SetObjectField(view, "armorText", CreateLabel("ArmorText", root.transform, new Vector2(0.5f, 0.72f), Vector2.zero, new Vector2(560f, 30f), "防具: -"));
        SetObjectField(view, "accessoryText", CreateLabel("AccessoryText", root.transform, new Vector2(0.5f, 0.44f), Vector2.zero, new Vector2(560f, 30f), "装飾: -"));
        TMP_Text summaryText = CreateLabel("EquipmentSummaryText", root.transform, new Vector2(0.5f, 0.24f), new Vector2(0f, 10f), new Vector2(640f, 56f), "戦闘構成: プレビュー未取得");
        SetObjectField(view, "summaryText", summaryText);
        TMP_Text matchupText = CreateLabel("EquipmentMatchupText", root.transform, new Vector2(0.5f, 0.10f), new Vector2(0f, 6f), new Vector2(640f, 32f), "次階層の見立て: 未取得");
        ...
        TMP_Text loadoutImpactText = CreateLabel("EquipmentImpactText", root.transform, new Vector2(0.5f, 0f), new Vector2(0f, 26f), new Vector2(650f, 54f), "装備影響: 未取得");
    ...
    private static DailyRewardView CreateDailyRewardView(Transform parent, string name, Vector2 anchor, Vector2 position)
    {
        ...
        SetObjectField(view, "statusText", CreateLabel("StatusText", root.transform, new Vector2(0.5f, 0.5f), Vector2.zero, new Vector2(560f, 40f), "デイリー報酬"));
        return view;
    }
    ...
    private static MissionItemView CreateMissionItemView(Transform parent, string name, Vector2 anchor, Vector2 position)
    {
        ...
        SetObjectField(view, "titleText", CreateLabel("TitleText", root.transform, new Vector2(0.2f, 0.5f), Vector2.zero, new Vector2(220f, 30f), "ミッション"));
        ...
        SetObjectField(view, "rewardText", CreateLabel("RewardText", root.transform, new Vector2(0.82f, 0.5f), Vector2.zero, new Vector2(180f, 30f), "報酬 0ゴールド"));
        return view;
    }
    ...
    private static ResultPanelController CreateResultPanel(Transform parent, BattleSceneController battleSceneController)
    {
        ...
        TMP_Text rewardStripLabel = CreateLabel("RewardStripLabel", rewardStrip.transform, new Vector2(0.5f, 1f), new Vector2(0f, -16f), new Vector2(300f, 22f), "今回の報酬");
        ...
        Button nextFloorButton = CreateButton(resultButtonRail.transform, "NextFloorButton", "次の階層へ", new Vector2(0.30f, 0.5f), Vector2.zero, new Vector2(220f, 52f));
        Button returnHomeButton = CreateButton(resultButtonRail.transform, "ReturnHomeButton", "ホームへ", new Vector2(0.70f, 0.5f), Vector2.zero, new Vector2(220f, 52f));
        StyleButton(nextFloorButton, new Color(0.18f, 0.47f, 0.66f, 1f));
        StyleButton(returnHomeButton, new Color(0.40f, 0.23f, 0.47f, 1f));
        CreatePrimaryButtonAura(nextFloorButton.transform, "NextFloorAura", new Vector2(248f, 70f), new Color(0.52f, 0.86f, 0.95f, 0.10f), "進行");
        CreatePrimaryButtonAura(returnHomeButton.transform, "ReturnHomeAura", new Vector2(248f, 70f), new Color(0.82f, 0.64f, 0.95f, 0.08f), "再編成");
        ...
        SetObjectField(controller, "titleText", CreateLabel("TitleText", root.transform, new Vector2(0.5f, 1f), new Vector2(0f, -40f), new Vector2(600f, 40f), "結果"));
        SetObjectField(controller, "goldText", CreateLabel("GoldText", rewardStrip.transform, new Vector2(0.30f, 0.34f), Vector2.zero, new Vector2(220f, 34f), "ゴールド +0"));
        SetObjectField(controller, "expText", CreateLabel("ExpText", rewardStrip.transform, new Vector2(0.70f, 0.34f), Vector2.zero, new Vector2(220f, 34f), "経験値 +0"));
        TMP_Text summaryText = CreateLabel("ResultSummaryText", root.transform, new Vector2(0.5f, 0.44f), new Vector2(0f, 8f), new Vector2(620f, 44f), "階層を突破しました。");
        ...
        TMP_Text rewardHintText = CreateLabel("RewardHintText", root.transform, new Vector2(0.5f, 0.30f), new Vector2(0f, 6f), new Vector2(620f, 52f), "報酬を確保し、次の行動を選びましょう。");
        ...
        TMP_Text nextRewardForecastText = CreateLabel("NextRewardForecastText", root.transform, new Vector2(0.5f, 0.20f), new Vector2(0f, 2f), new Vector2(620f, 44f), "次回報酬予測: 第2階層は約10ゴールドと経験値5です。");
        ...
        TMP_Text nextActionText = CreateLabel("NextActionText", nextMoveStrip.transform, new Vector2(0.5f, 0.5f), Vector2.zero, new Vector2(560f, 28f), "次の行動");
